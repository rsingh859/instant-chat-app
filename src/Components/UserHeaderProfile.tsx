...
function UserHeaderProfile({ user, handleClick }: UserHeaderProfileProps) {
  return (
    <div
      onClick={handleClick}
    ...
    >
      <div className="relative">
        ...
        />
        <span className="-top-1 left-7 absolute w-4 h-4 rounded-full border-2 border-gray-800 bg-green-400"></span>
      </div>
